-- Commandes web client : en attente de validation staff avant cuisine.
...
-- Les commandes site client démarrent en a_valider (pas encore en cuisine).
...
-- Édition staff d'une commande web avant validation cuisine.
...
-- Validation staff → envoie en cuisine (en_attente).
